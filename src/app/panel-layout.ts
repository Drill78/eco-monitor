  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        if (SITE_VARIANT === 'eco') {
          return `<a href="#" class="variant-option active" data-variant="eco" title="生态">
              <span class="variant-icon">\u{1F33F}</span>
              <span class="variant-label">生态</span>
            </a>`;
        }
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">${SITE_VARIANT === 'eco' ? 'WIEE ECO MONITOR' : 'WORLD MONITOR'}</span>
        ...
        ${SITE_VARIANT === 'eco' ? `<span class="mobile-menu-item"><span class="mobile-menu-item-icon">\u{1F33F}</span><span class="mobile-menu-item-label">@wiee</span></span>` : `<a class="mobile-menu-item" href="https://x.com/eliehabib" target="_blank" rel="noopener">
        ...
        <div class="mobile-menu-footer-links">
          ${SITE_VARIANT === 'eco' ? '<span>@wiee</span>' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/pro' : 'https://www.worldmonitor.app/pro'}" target="_blank" rel="noopener">Pro</a>
        ...
        <div class="mobile-menu-version">${SITE_VARIANT === 'eco' ? 'v0.2' : `v${__APP_VERSION__}`}</div>
      </nav>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">${SITE_VARIANT === 'eco' ? 'WIEE ECO MONITOR' : 'WORLD MONITOR'}</span>
            <span class="site-footer-sub">${SITE_VARIANT === 'eco' ? 'by WIEE' : 'by Someone.ceo'}</span>
          </div>
        </div>
        <nav>
          ${SITE_VARIANT === 'eco' ? '<span>@wiee</span>' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/pro' : 'https://www.worldmonitor.app/pro'}" target="_blank" rel="noopener">Pro</a>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} ${SITE_VARIANT === 'eco' ? 'WIEE' : 'World Monitor'}</span>
      </footer>
    `;
