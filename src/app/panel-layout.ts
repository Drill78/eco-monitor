    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">${SITE_VARIANT === 'eco' ? 'WIEE' : 'MONITOR'}</span><span class="logo-mobile">${SITE_VARIANT === 'eco' ? 'WIEE Eco Monitor' : 'World Monitor'}</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
